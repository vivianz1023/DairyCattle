...
```{r Results-correlation plots 1, echo=FALSE, fig.align='center', out.width="70%"}
 # ----------- Test 1 water_feed ------------------------------------
  # feed bins overall
...
```{r Results-correlation plots 2, echo=FALSE, fig.align='center', out.width="50%"}
# ----------- Test 2 water_feed_high_cor ------------------------------------
  ...
  df_fh_wh <- data.frame(x = rank(unname(sorted_last_elo_feed_high_THI), ties.method = 'average'), y = rank(unname(sorted_last_elo_water_high_THI), ties.method = 'average'))
  sp_df_fh_wh <- ggscatter(df_fh_wh, x = 'x', y = 'y',
   ...
   ) + labs(caption = "Figure 4.2: Correlation between the dominance ranks at Feed Bin and Water Bin under High THI (> 65)")
  ...
  df_fl_wl <- data.frame(x = rank(unname(sorted_last_elo_feed_low_THI), ties.method = 'average'), y = rank(unname(sorted_last_elo_water_low_THI), ties.method = 'average'))
  sp_df_fl_wl <- ggscatter(df_fl_wl, x = 'x', y = 'y',
   ...
   ) + labs(caption = "Figure 4.3: Correlation between the dominance ranks at Feed Bin and Water Bin under Low THI (<= 65)")
...
```{r Results-correlation plots 3, echo=FALSE, fig.align='center', out.width="50%"}
