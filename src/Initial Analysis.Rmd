...
sorted_last_elo_feed_low_THI <- last_elo_feed_low_THI[sort(names(last_elo_feed_low_THI))]
sorted_last_elo_feed_high_THI <- last_elo_feed_high_THI[sort(names(last_elo_feed_high_THI))]
sorted_last_elo_water_low_THI <- last_elo_water_low_THI[sort(names(last_elo_water_low_THI))]
sorted_last_elo_water_high_THI <- last_elo_water_high_THI[sort(names(last_elo_water_high_THI))]
...
cor.test(x=unname(sorted_last_elo_water_high_THI), y=unname(sorted_last_elo_water_low_THI), method = 'spearman')
```
